...
from lib.battleroyalecalculation import get_m_stat, get_win_stat
...
def send_code():
    res = send_verification_code(login_entry_phone.get())
    print(res)
...
def login():
    res = login(login_entry_phone.get(), login_entry_code.get())
    if res.get("errorCode") == 400:
